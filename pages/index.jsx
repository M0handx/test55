    ...
    <div style={{ width: "100%", padding: "100px", alignContent: "center" }}>
      <header>
        ...
        <h4>
          ...
          <h3>Your pages:</h3>
          <ul>
            <li><Link href="/canvas-en">CanvasLandingEn - /canvas-en</Link></li>
<li><Link href="/canvas-investors-en">CanvasInvestorsEn - /canvas-investors-en</Link></li>
<li><Link href="/canvas-investors-ar">CanvasInvestorsAr - /canvas-investors-ar</Link></li>
<li><Link href="/canvas-enterpreneurs-en">CanvasEnterpreneursEn - /canvas-enterpreneurs-en</Link></li>
<li><Link href="/canvas-enterpreneurs-ar">CanvasEnterpreneursAr - /canvas-enterpreneurs-ar</Link></li>
<li><Link href="/canvas-ar">CanvasLandingsAr - /canvas-ar</Link></li>
          </ul>
