...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: FNRjNEPGBU62/css
import SearchSvgIcon from "./icons/PlasmicIcon__SearchSvg"; // plasmic-import: q_DOpnBrE4dr/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__xohbq)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__x3Txx)}
              role={"img"}
            />
          ),
