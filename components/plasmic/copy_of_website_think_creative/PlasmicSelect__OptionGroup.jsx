...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: 1nsJYG1FSf78/css
import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: QNq2mEWG3oe5/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__oCc3E)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__wbkvp)}
              />
            </React.Fragment>
          ),
